...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Aquí define los nombres e iconos visuales para cada tipo de incidente
    ...
    const renderMarkers = (geojsonData) => {
        ...
        const geoJsonLayer = L.geoJSON(geojsonData, {
            onEachFeature: (feature, layer) => {
                ...
                // Aquí convierte el tipo de incidente guardado en su nombre visible con icono para la ventana flotante
                const catDisplay = categoryLabels[props.category] || props.category;
                ...
                const popupContent = `
                    <div style="min-width: 230px;">
                        ...
                        <p style="font-size:0.85rem; margin:6px 0;"><strong>Tipo:</strong> <span>${catDisplay}</span></p>
